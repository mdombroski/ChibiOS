...
ROMCONST chdebug_t ch_debug = {
  ...
  (uint8_t)sizeof (chThread),
  (uint8_t)_offsetof(chThread, p_prio),
  (uint8_t)_offsetof(chThread, p_ctx),
  (uint8_t)_offsetof(chThread, p_newer),
  (uint8_t)_offsetof(chThread, p_older),
  (uint8_t)_offsetof(chThread, p_name),
#if CH_DBG_ENABLE_STACK_CHECK
  (uint8_t)_offsetof(chThread, p_stklimit),
#else
  (uint8_t)0,
#endif
  (uint8_t)_offsetof(chThread, p_state),
  (uint8_t)_offsetof(chThread, p_flags),
#if CH_USE_DYNAMIC
  (uint8_t)_offsetof(chThread, p_refs),
#else
  (uint8_t)0,
#endif
#if CH_TIME_QUANTUM > 0
  (uint8_t)_offsetof(chThread, p_preempt),
#else
  (uint8_t)0,
#endif
#if CH_DBG_THREADS_PROFILING
  (uint8_t)_offsetof(chThread, p_time)
#else
  (uint8_t)0
#endif
};
