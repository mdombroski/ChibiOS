 ...
 *          Each thread has a mask of pending event flags inside its @p chThread
 *          structure.
...
/**
 * @brief   Adds a set of event flags directly to specified @p chThread.
 *
 ...
 * @api
 */
void chEvtSignal(chThread *tp, eventmask_t mask) {
 ...
 * @iclass
 */
void chEvtSignalI(chThread *tp, eventmask_t mask) {
